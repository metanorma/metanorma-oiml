    ...
    module Sts
      module Transformer
        ...
        module ModelBuilder
          ...
          def non_normative_note(paragraph: [])
            ::Sts::IsoSts::NonNormativeNote.new(paragraph: Array(paragraph))
          end

          def non_normative_example(paragraph: [])
            ::Sts::IsoSts::NonNormativeExample.new(paragraph: Array(paragraph))
          end
